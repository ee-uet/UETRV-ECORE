...
set ::env(datetime) {2022.03.21_23.20.36}
...
set ::env(CURRENT_DEF) /home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/routing/Core.def
set ::env(CURRENT_GUIDE) /home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/routing/19-global.guide
set ::env(CURRENT_INDEX) 37
set ::env(CURRENT_NETLIST) /home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/finishing/31-powered_netlist.v
set ::env(PREV_NETLIST) /home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/routing/21-detailed.v
set ::env(PDK_ROOT) {/home/ali112000/Desktop/mpw/pdk}
set ::env(ANTENNA_CHECKER_LOG) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/logs/finishing/36-antenna.log}
set ::env(ANTENNA_CHECK_CURRENT_DEF) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/routing/Core.def}
set ::env(BASE_SDC_FILE) {/openlane/scripts/base.sdc}
set ::env(BOTTOM_MARGIN_MULT) {4}
set ::env(CARAVEL_ROOT) {/home/ali112000/mpw5/UETRV-ECORE/caravel}
set ::env(CARRY_SELECT_ADDER_MAP) {/home/ali112000/Desktop/mpw/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/csa_map.v}
set ::env(CELLS_LEF) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/merged.lef}
set ::env(CELLS_LEF_OPT) {/home/ali112000/Desktop/mpw/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lef/sky130_fd_sc_hd.lef}
set ::env(CELLS_LEF_UNPADDED) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/merged_unpadded.lef}
set ::env(CELL_CLK_PORT) {CLK}
set ::env(CELL_PAD) {2}
set ::env(CELL_PAD_EXCLUDE) {sky130_fd_sc_hd__tap* sky130_fd_sc_hd__decap* sky130_fd_sc_hd__fill*}
set ::env(CHECK_ASSIGN_STATEMENTS) {0}
...
set ::env(CTS_CLK_BUFFER_LIST) {sky130_fd_sc_hd__clkbuf_2 sky130_fd_sc_hd__clkbuf_4 sky130_fd_sc_hd__clkbuf_8}
set ::env(CTS_CLK_MAX_WIRE_LENGTH) {0}
set ::env(CTS_CURRENT_DEF) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/placement/Core.def}
set ::env(CTS_DISABLE_POST_PROCESSING) {0}
set ::env(CTS_MAX_CAP) {1.53169}
set ::env(CTS_REPORT_TIMING) {1}
set ::env(CTS_ROOT_BUFFER) {sky130_fd_sc_hd__clkbuf_16}
...
set ::env(CTS_TOLERANCE) {100}
set ::env(CURRENT_DEF) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/routing/Core.def}
set ::env(CURRENT_GDS) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/finishing/Core.gds}
set ::env(CURRENT_GUIDE) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/routing/19-global.guide}
set ::env(CURRENT_INDEX) {37}
set ::env(CURRENT_NETLIST) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/finishing/31-powered_netlist.v}
set ::env(CURRENT_SDC) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/cts/13-resizer_timing.sdc}
set ::env(CURRENT_SDF) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/routing/Core.sdf}
set ::env(CURRENT_SPEF) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/routing/Core.ff.spef}
...
set ::env(DIODE_CELL) {sky130_fd_sc_hd__diode_2}
set ::env(DIODE_CELL_PIN) {DIODE}
set ::env(DIODE_INSERTION_CURRENT_DEF) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/routing/Core.def}
set ::env(DIODE_INSERTION_STRATEGY) {4}
set ::env(DIODE_PADDING) {2}
...
set ::env(DRC_CURRENT_DEF) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/routing/Core.def}
set ::env(DRC_EXCLUDE_CELL_LIST) {/home/ali112000/Desktop/mpw/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/drc_exclude.cells}
set ::env(DRC_EXCLUDE_CELL_LIST_OPT) {/home/ali112000/Desktop/mpw/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/drc_exclude.cells}
set ::env(DRT_OPT_ITERS) {64}
set ::env(ECO_ENABLE) {0}
...
set ::env(ECO_SKIP_PIN) {1}
set ::env(ECO_STARTED) {0}
set ::env(EXT_NETLIST) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/finishing/Core.spice}
set ::env(FAKEDIODE_CELL) {sky130_ef_sc_hd__fakediode_2}
set ::env(FILL_CELL) {sky130_fd_sc_hd__fill_}
set ::env(FILL_INSERTION) {1}
set ::env(FP_ASPECT_RATIO) {1}
...
set ::env(GPIO_PADS_VERILOG) { /home/ali112000/Desktop/mpw/pdk/sky130A/libs.ref/sky130_fd_io/verilog/sky130_ef_io.v /home/ali112000/Desktop/mpw/pdk/sky130A/libs.ref/sky130_fd_io/verilog/sky130_ef_io__gpiov2_pad_wrapped.v }
set ::env(HOME) {/}
set ::env(HOSTNAME) {fa39e7669c0e}
set ::env(INPUT_DEF) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/finishing/31-powered_def.def}
set ::env(IO_PCT) {0.2}
set ::env(KLAYOUT_DRC_KLAYOUT_GDS) {0}
set ::env(KLAYOUT_DRC_TECH_SCRIPT) {/home/ali112000/Desktop/mpw/pdk/sky130A/libs.tech/klayout/sky130A_mr.drc}
set ::env(KLAYOUT_PROPERTIES) {/home/ali112000/Desktop/mpw/pdk/sky130A/libs.tech/klayout/sky130A.lyp}
...
set ::env(LAST_TIMING_REPORT_TAG) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/reports/routing/26-parasitics_sta}
set ::env(LAYERS_RC) { li1 1.499e-04 7.176e-02, met1 1.449e-04 8.929e-04, met2 1.331e-04 8.929e-04, met3 1.464e-04 1.567e-04, met4 1.297e-04 1.567e-04, met5 1.501e-04 1.781e-05}
...
set ::env(LEC_ENABLE) {0}
set ::env(LEFT_MARGIN_MULT) {12}
set ::env(LIB_CTS) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/cts/cts.lib}
set ::env(LIB_FASTEST) {/home/ali112000/Desktop/mpw/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ff_n40C_1v95.lib}
set ::env(LIB_RCX) {/home/ali112000/Desktop/mpw/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ff_n40C_1v95.lib}
set ::env(LIB_RESIZER_OPT) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/synthesis/resizer_sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LIB_SLOWEST) {/home/ali112000/Desktop/mpw/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ss_100C_1v60.lib}
set ::env(LIB_SLOWEST_OPT) {/home/ali112000/Desktop/mpw/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__ss_100C_1v60.lib}
set ::env(LIB_SYNTH) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/synthesis/trimmed.lib}
...
set ::env(LIB_SYNTH_COMPLETE_NO_PG) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/synthesis/1-sky130_fd_sc_hd__tt_025C_1v80.no_pg.lib}
set ::env(LIB_SYNTH_MERGED) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/synthesis/merged.lib}
set ::env(LIB_TYPICAL) {/home/ali112000/Desktop/mpw/pdk/sky130A/libs.ref/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib}
set ::env(LOGS_DIR) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/logs}
set ::env(LVS_CONNECT_BY_LABEL) {0}
set ::env(LVS_CURRENT_DEF) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/routing/Core.def}
set ::env(LVS_INSERT_POWER_PINS) {1}
set ::env(MACRO_BLOCKAGES_LAYER) {li1 met1 met2 met3 met4}
set ::env(MAGIC_CONVERT_DRC_TO_RDB) {1}
set ::env(MAGIC_DISABLE_HIER_GDS) {1}
set ::env(MAGIC_DRC_USE_GDS) {1}
set ::env(MAGIC_EXT_USE_GDS) {0}
set ::env(MAGIC_GDS) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/finishing/Core.magic.gds}
set ::env(MAGIC_GENERATE_GDS) {1}
set ::env(MAGIC_GENERATE_LEF) {1}
set ::env(MAGIC_GENERATE_MAGLEF) {1}
set ::env(MAGIC_INCLUDE_GDS_POINTERS) {0}
...
set ::env(MERGED_LEF) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/merged.lef}
set ::env(MERGED_LEF_ORIGINAL) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/merged.lef}
set ::env(MERGED_LEF_UNPADDED) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/merged_unpadded.lef}
set ::env(MERGED_LEF_UNPADDED_ORIGINAL) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/merged_unpadded.lef}
set ::env(MERGED_LEF_UNPADDED_WIDENED) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/merged_unpadded.lef}
set ::env(MERGED_LEF_WIDENED) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/merged.lef}
set ::env(NETGEN_SETUP_FILE) {/home/ali112000/Desktop/mpw/pdk/sky130A/libs.tech/netgen/sky130A_setup.tcl}
set ::env(NO_SYNTH_CELL_LIST) {/home/ali112000/Desktop/mpw/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/no_synth.cells}
...
set ::env(PDK_ROOT) {/home/ali112000/Desktop/mpw/pdk}
set ::env(PDN_CFG) {/openlane/scripts/openroad/pdn_cfg.tcl}
set ::env(PGA_RPT_FILE) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/floorplan/6-pdn.pga.rpt}
set ::env(PLACEMENT_CURRENT_DEF) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/floorplan/6-pdn.def}
set ::env(PLACE_SITE) {unithd}
set ::env(PLACE_SITE_HEIGHT) {2.720}
set ::env(PLACE_SITE_WIDTH) {0.460}
set ::env(PL_BASIC_PLACEMENT) {0}
...
set ::env(ROOT_CLK_BUFFER) {sky130_fd_sc_hd__clkbuf_16}
set ::env(ROUTING_CORES) {2}
set ::env(ROUTING_CURRENT_DEF) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/cts/13-resizer_timing.def}
set ::env(RT_MAX_LAYER) {met4}
set ::env(RT_MIN_LAYER) {met1}
set ::env(RUN_CVC) {1}
set ::env(RUN_DIR) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core}
...
set ::env(RUN_TAG) {Core}
set ::env(SAVE_DEF) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/routing/Core.def}
set ::env(SAVE_FINAL_VIEWS) {1}
set ::env(SAVE_GUIDE) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/routing/19-global.guide}
set ::env(SAVE_NETLIST) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/finishing/31-powered_netlist.v}
set ::env(SAVE_SDC) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/cts/13-resizer_timing.sdc}
set ::env(SAVE_SDF) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/routing/Core.sdf}
set ::env(SCRIPTS_DIR) {/openlane/scripts}
set ::env(SHLVL) {1}
set ::env(SPEF_EDGE_CAP_FACTOR) {1}
set ::env(SPEF_EXTRACTOR) {openrcx}
set ::env(SPEF_FASTEST) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/routing/Core.ff.spef}
set ::env(SPEF_SLOWEST) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/routing/Core.ss.spef}
set ::env(SPEF_TYPICAL) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/routing/Core.tt.spef}
set ::env(SPEF_WIRE_MODEL) {L}
set ::env(STA_REPORT_POWER) {1}
set ::env(STD_CELL_GROUND_PINS) {VGND VNB}
set ::env(STD_CELL_LIBRARY) {sky130_fd_sc_hd}
...
set ::env(TOP_MARGIN_MULT) {4}
set ::env(TRACKS_INFO_FILE) {/home/ali112000/Desktop/mpw/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tracks.info}
set ::env(TRACKS_INFO_FILE_PROCESSED) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/routing/config.tracks}
set ::env(TRISTATE_BUFFER_MAP) {/home/ali112000/Desktop/mpw/pdk/sky130A/libs.tech/openlane/sky130_fd_sc_hd/tribuff_map.v}
set ::env(TRITONROUTE_FILE_PREFIX) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/routing/detailed}
set ::env(TRITONROUTE_RPT_PREFIX) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/reports/routing/detailed}
set ::env(USE_ARC_ANTENNA_CHECK) {1}
set ::env(USE_GPIO_PADS) {0}
...
set ::env(cts_tmpfiles) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/cts}
set ::env(datetime) {2022.03.21_23.20.36}
set ::env(drc_prefix) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/reports/finishing/drc}
set ::env(eco_logs) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/logs/eco}
set ::env(eco_reports) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/reports/eco}
set ::env(eco_results) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/eco}
set ::env(eco_tmpfiles) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/eco}
...
set ::env(floorplan_results) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/floorplan}
set ::env(floorplan_tmpfiles) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/floorplan}
set ::env(fp_report_prefix) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/reports/floorplan/3-initial_fp}
set ::env(magic_extract_prefix) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/logs/finishing/31-ext2}
set ::env(placement_logs) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/logs/placement}
set ::env(placement_reports) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/reports/placement}
set ::env(placement_results) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/placement}
set ::env(placement_tmpfiles) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/placement}
...
set ::env(routing_results) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/routing}
set ::env(routing_tmpfiles) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/routing}
set ::env(synth_report_prefix) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/reports/synthesis/1-synthesis}
set ::env(synthesis_logs) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/logs/synthesis}
set ::env(synthesis_reports) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/reports/synthesis}
set ::env(synthesis_results) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/results/synthesis}
set ::env(synthesis_tmpfiles) {/home/ali112000/mpw5/UETRV-ECORE/openlane/Core/runs/Core/tmp/synthesis}
set ::env(timer_end) {1647905874}
set ::env(timer_routed) {1647905661}
set ::env(timer_start) {1647904836}
